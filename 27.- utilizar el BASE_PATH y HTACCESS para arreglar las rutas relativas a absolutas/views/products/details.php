<?php 
  ...
  $productos = $productsController->getBySlug($_GET['slug']);
?>
<!doctype html>
<html lang="en">
  <!-- [Head] start -->
              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="sticky-md-top product-sticky">
                      <div id="carouselExampleCaptions" class="carousel slide ecomm-prod-slider" data-bs-ride="carousel">
                        <div class="carousel-inner bg-light rounded position-relative">
                          ...
                          <img src="<?= $productos -> cover ?>" class="d-block wid-500" alt="Product images" />
                          </div>
                        ...
                        <ol class="list-inline carousel-indicators position-relative product-carousel-indicators my-sm-3 mx-0">
                          ...
                          <img src="<?= $productos -> cover ?>" class="d-block wid-100" alt="Product images" />
                  ...
                  <div class="col-md-6">
                    ...
                    <h5 class="my-3"> <?= $productos -> name ?></h5>
                    ...
                    <ul>
                      <li class="mb-2"> <?= $productos -> description ?> </li>
                      <li class="mb-2"><?= $productos -> slug?></li>
                      <li class="mb-2"><?= $productos -> features?></li>
                      <li class="mb-2">brand:<?= $productos -> brand->name?></li>
                    </ul>
